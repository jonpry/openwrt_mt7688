...
$(eval $(call SetupHostCommand,gcc, \
	...
	$(CC) -dumpversion | grep -E '(4\.[8-9]|5\.?[0-9]?|6\.?[0-9]?|7\.?[0-9]?|8)', \
	gcc -dumpversion | grep -E '(4\.[8-9]|5\.?[0-9]?|6\.?[0-9]?|7\.?[0-9]?|8)', \
...
$(eval $(call SetupHostCommand,g++, \
	...
	$(CXX) -dumpversion | grep -E '(4\.[8-9]|5\.?[0-9]?|6\.?[0-9]?|7\.?[0-9]?|8)', \
	g++ -dumpversion | grep -E '(4\.[8-9]|5\.?[0-9]?|6\.?[0-9]?|7\.?[0-9]?|8)', \
	g++48 --version | grep g++, \
	g++49 --version | grep g++, \
	g++5 --version | grep g++, \
	g++6 --version | grep g++, \
